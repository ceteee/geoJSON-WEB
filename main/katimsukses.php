  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item active">
          ...
          <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item active" href="katimsukses.php">Kepala Tim Sukses</a>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                        <div class="col-xl-9">
                            <h6 class="m-0 font-weight-bold text-secondary">Ketua Tim Sukses</h6>
                        </div>
      ...
      <?php
          ...
          $sql = "SELECT nama, foto FROM katimses";
          ...
          if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
              ...
              echo "<div class='card-body'>";
                echo "<div class='row'>";
                  echo "<img src='data:image/jpeg;base64,".base64_encode($foto)."' alt='ketua tim sukses' style='width: 200px; height: 240px; margin-left: auto; margin-right: auto; border:solid 1px;' />";
               echo "</div>";
                echo "<div class='row'>";
                   echo "<h5 style='margin-left:auto ; margin-top :10px ;margin-right: auto; '>$nama</h5>";
                echo "</div>";
              echo "</div>";               
            }
          } else {
