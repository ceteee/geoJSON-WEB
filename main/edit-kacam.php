    ...
    <ul class="navbar-nav bg-gradient-info sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <div id="content-wrapper" class="d-flex flex-column">
        ...
        <?php              
							include('php/connection.php');
							$id=$_GET['id'];
								$show=mysqli_query($conn,"SELECT * FROM katimcam WHERE idcam='$id'");
        ...
        <div class="card-body">
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="text" class="form-control" id="inputPassword" placeholder="Nama" value="<?php echo $data['nama'];?>" name="nama">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <hr>
                    <button type="submit" class="btn btn-danger btn-user btn-block" style="width:200px; margin-left:auto;" name="simpankacam">
                      Ubah
                    </button> 
                    <a href="table-kacam.php" class="btn btn-secondary btn-user btn-block" style="width:200px; margin-left:auto;">
                      Kembali
                    </a>
        </div>
